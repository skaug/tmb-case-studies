...
## **GAM model based on P-splines (UNDER MAINTAINANCE!!!!!!)**
...
<details>
  ...
  We use the GMRF() function in C++ for calculation of the prior contribution, note that we calculate the normalizing constant on the R side since S does not have full rank. 
```c++
