...
<details>
  ...
  The negative log likelihood contribution from each spline is $0.5 m_i  \log\lambda_i - 0.5 \lambda_i \pmb{\beta}_i \pmb{S}_i \pmb{\beta}_i^T$, were $m_i=\dim(\beta_i)=\dim(S_i)$. 
```c++
