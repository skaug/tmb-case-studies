...
<details>
  ...
  The negative log likelihood contribution from each spline is $0.5 \text{log} \lambda_i m_i - 0.5 \lambda_i \pmb{\beta}_i \pmb{S}_i \pmb{\beta}_i^T$, were $m_i$ is the number of regression parameters for the $i$th spline. 
```c++
