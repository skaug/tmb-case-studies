...
where $R(\cdot)$ is a function describing the spawning productivity of the cod, $A$ represents a maximum age, $F$ represents the fishing mortality and $M$ the natural mortality. It is assumed that the process error, $\eta_{a,y}$, is iid N(0,$\sigma_{\eta,a}^2$), i.e. 
