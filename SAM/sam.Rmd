...
```
The variable `fleet` provides information about if the observation is commercial catch or which survey it is from. In this example refere the value 1 to catch data, and 2 and 3 to the two separate surveys.
</details>
