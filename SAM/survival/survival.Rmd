...
born ($R_y$) in year $y$. The next step is to look at survival of individuals aged $a$ 
...
\end{equation}
where the contribution is the survival form last year in the age group below, but also from the same age group from last year, since all older fish are contained in this final age group.
