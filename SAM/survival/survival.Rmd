...
\begin{equation}
  \label{eq:survival}
  \log N_{A,y} = \log N_{A-1,y-1} - F_{A-1,y-1} - M_{A-1, y-1} + \log N_{A,y-1} - F_{A,y-1} - M_{A, y-1} + \epsilon_{Ay}, 
\end{equation}
...
\begin{align}
 ...
 \log N_{A,y} &= \log N_{A-1,y-1} - F_{A-1,y-1} - M_{A-1, y-1} + \log N_{A,y-1} - F_{A,y-1} - M_{A, y-1} + \eta_{Ay}\end{align}
